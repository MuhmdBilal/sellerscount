...
const Product = ({
  ...
  return (
    <Accordion
      activeKey={activeKey?.productDetails === true ? "0" : "1"}
      className="modal-body-brand"
    >
      <Accordion.Item eventKey="0">
        ...
        <Accordion.Body className="accordion-product">
          <Row className="position-relative product-row">
            <Col lg={4} md={4} xs={4}>
                  ...
                  <Tooltip
                    title={
                      <div className="content-tooltip">
                        ...
                        <span>
                          length: {productDetails?.dimensions?.length} <br />
                        ...
                        <span>
                          ...
                          {/* {productDetails?.dimensions?.weight + " ounces"}
